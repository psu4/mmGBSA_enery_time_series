...
def main(argv):
    ...
    ax.legend([line1,line2,line3,line4,line7,line8], ['dGvdw','dGelec','dGGB','dGnonpolar','dGsolv','dGbind'],bbox_to_anchor=[0.5,-0.26],loc='center',ncol=3,fontsize=20)#,fancybox=True
